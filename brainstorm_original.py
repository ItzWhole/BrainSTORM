...
# -*- coding: utf-8 -*-
"""
BrainSTORM Original Research Code

Original research implementation for STORM microscopy analysis.
This file contains the experimental code that was used to develop
the neural network architecture and training procedures.

For production use, please use storm_gui.py instead.
...
#%%
ckpt_path=f'/home/lautaro/Downloads/brainstorm_models/modelo_{distance}.keras'
# Model
...
def plot_true_vs_pred_heatmap_aligned_nm(
    ...
    plt.show()
#%%
mp = '/home/lautaro/Downloads/brainstorm_models/'
...
# model = tf.keras.models.load_model('/home/lautaro/Downloads/brainstorm_models/modelo_18_nosigmoid100+185epochs_variedroutineESTEESELBUENO.keras')
